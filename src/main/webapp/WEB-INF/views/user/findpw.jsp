      ...
      $(document).ready(function() {
           $("#findpw").click(function() {
               if($("#userId").val() == "") {
                  ...
                  $("#findform").attr("action", "${root}/mem/findpwd").submit();
               }
            });
         });
</script>
      ...
      <div class="row" style="float: center;">
         ...
         <div class="col-sm-4 ">
            <form method="post" action="" id="findform">
               <p class='text-left'>아이디를 입력하세요.</p>
               <input type="id" id="userId" name="userId"
                  class="form-control userInfo" placeholder="ID" required>
               <hr>
               <p class='text-left'>이름을 입력하세요.</p>
