...
<script type="text/javascript">
	...
	$(document).ready(
			function() {
				$.get("${root}/dong/sido", {}, function(data, status) {
					...
					function() {
						...
						$("#searchDo").on(
								...
								function() {
									...
									var isapt = $('input[name="apt"]').is(
											":checked")
									var ishouse = $('input[name="house"]').is(
											":checked")
																...
																$
																		.each(
																				...
																				function(
																					...
																					$(
																							'#model-body-detail #detail-table-body')
																							.append(
																									str);
																					return false;
																				});
																								...
																								.each(
																										...
																										function(
																											...
																											let str = '<tr>'
																													...
																													+ "</tr>";
																											$(
																													'#model-body-detail #detail-table-body1')
																													.append(
																															str);
																										});
																					} else {
																									...
																									.each(
																											...
																											function(
																												...
																												let str = '<tr>'
																														...
																														+ "</tr>";
																												$(
																														'#model-body-detail #detail-table-body2')
																														.append(
																																str);
																											});
																						} else {
																									...
																									.each(
																											...
																											function(
																												...
																												let str = '<tr>'
																														...
																														+ "</tr>";
																												$(
																														'#model-body-detail #detail-table-body3')
																														.append(
																																str);
																											});
																						}
	...
	function add() {
		let value = $("#noInfo").text();
		$("#inputno").val(value);
		$("#noform").attr("action", "${root}/dong/add");
		$("#noform").submit();
		alert('추가되었습니다.');
	}
	...
	function move(address) {
		...
		$.get("https://maps.googleapis.com/maps/api/geocode/json", {
			...
			map.setZoom(15);
			map.setCenter(new google.maps.LatLng(parseFloat(tmpLat),
					parseFloat(tmpLng)));
				...
				<ul class="nav navbar-nav navbar-right">
					<c:if test="${member eq null }">
						<li class="nav-item loggedIn"><a data-toggle="modal"
							...
							style="color: white; font-size: 20px; font-weight: bold"><span
						...
						<li class="nav-item loggedIn"><a id="signupPage"
							class="glyphicon glyphicon-user" href="${root}/mem/join"
							style="color: white; font-size: 20px; font-weight: bold" style="color: white;font-size:20px;font-weight:bold">Join</a></li>
					</c:if>
