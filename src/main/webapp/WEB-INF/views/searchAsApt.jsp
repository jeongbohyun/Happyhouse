...
<script type="text/javascript">
   ...
   $(document).ready(function() {
      ...
      $('#searchDo').on("click", function() {
         ...
         if($('#searchAptName').val() != ""){
            $.get("${root}/aptt/name"
                  ,{
                  aptName:$("#searchAptName").val(),
                  apt: isapt,
                  house: ishouse,
                  a: a,
                  b: b,
   ...
   /* function marking(jsonData) {
      ...
      $.each(jsonData, function(index, vo) {
         tmplat = parseFloat(vo.lat);
         tmplng = parseFloat(vo.lng);
      ...
      let coord = {lat: tmplat, lng: tmplng};
      map.panTo(coord);
      map.setOptions({
         zoom: 16
      });
         ...
         <div class="col-sm-10">
			<div class="row" style="height: 30px; float: center">
				...
				<div class="form-group col-sm-3">
                  <input id="searchAptName" placeholder="아파트이름">
                  <a class="search glyphicon glyphicon-search" id="searchDo"></a>
               </div>	
